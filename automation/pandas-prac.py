...
coffee_sales = pd.read_csv('automation/coffee_sales.csv')
...
# print(coffee_sales.loc[[1,3,5] , 'Units']) #filtering based on index and coffee type ###--> The column index rather
...
# print(coffee_sales.iat[0,0]) #this only works for specific item sin the dataframe
